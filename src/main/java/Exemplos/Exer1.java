...
public class Exer1 {
    public static void main(String[] args) {
        ...
        System.out.printf("Products: " +product1+ ", which price is $%.2f %n ", price1); //"%.(quantidade de casas decimais)f (Texto após a variável(Opcional))%n", Variável para arredondar
